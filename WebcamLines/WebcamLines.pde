/* Webcam Vertical Line Pixelator
 * by Mark Clifton, 2012
 * mark-clifton.com
 * Processing sketch that renders live video input as a mosaic of vertical line-shaped pixels.
...
void draw() {
  ...
  for (int i = 0; i < cols; i++) {
    ...
    for (int j = 0; j < rows; j++) {
      ...
      strokeWeight(3);
      stroke(0);
      rect(x,y,pixelSize1,pixelSize2);
    }
  }
}